...
def over_all_twitter_metrics():
    con=conn()
    mapping_query = "SELECT url,id,content,replycount,retweetcount,likecount,quotecount,username,year,month,hour,month_year,hashtag,mentions,tweets_no_stopwords,vader_sentiment,computed_date,computed_time FROM twitter_leaders_user_level_finall_table"
